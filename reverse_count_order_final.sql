-- Reverse Count Order: Older Jobs Get Lower Numbers, Newer Jobs Get Higher Numbers
...
-- 4. Create a temporary table with reversed Count values
...
SELECT 
  old_count,
  250000 + (SELECT COUNT(*) FROM all_jobs) - row_num + 1 as new_count
FROM ordered_jobs;
