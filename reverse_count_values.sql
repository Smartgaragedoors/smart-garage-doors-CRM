-- Reverse Count Values - Make First Job 250001
...
-- 3. Create a temporary table with reversed Count values
...
-- 7. Update all Count values to reversed sequential format
UPDATE all_jobs 
